...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Compassionate home nursing, doctor visits, physiotherapy and elder care in Vellore. Available 24/7." },
    ],
  }),
  component: Home,
});
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-hero">
        ...
        <div className="absolute -bottom-32 -left-20 h-96 w-96 rounded-full bg-accent-coral/10 blur-3xl animate-float-slow" style={{ animationDelay: "1.5s" }} />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center relative">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-5 font-display text-4xl sm:text-5xl lg:text-6xl text-foreground leading-tight">
              Compassionate <span className="text-brand">home healthcare</span> for the ones you love.
            </h1>
            <p className="mt-5 text-lg text-muted-foreground max-w-xl">
              From bedside nursing to doctor visits, physiotherapy and elder care — Care Touch brings hospital-grade care to the comfort of your home.
            </p>
            ...
            <div className="mt-10 grid grid-cols-3 gap-4 max-w-md">
              {[
                ...
                <div key={s.l} className="text-center rounded-xl bg-white/60 backdrop-blur border border-border/60 p-3">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            { icon: ShieldCheck, title: "Verified Professionals", desc: "Trained, background-checked nurses and caregivers." },
            { icon: Clock, title: "On-Demand Care", desc: "Same-day visits and round-the-clock availability." },
            { icon: Award, title: "Patient-First Approach", desc: "Personalised care plans for every patient." },
          ].map((f, i) => (
            <div key={f.title} className="rounded-2xl border border-border/60 bg-card p-6 hover:shadow-card transition animate-fade-up" style={{ animationDelay: `${i * 100}ms` }}>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
          <div>
            ...
            <h2 className="mt-2 font-display text-3xl sm:text-4xl">Complete care, under one roof</h2>
          </div>
          <Link to="/services" className="text-sm font-medium text-brand hover:text-brand-deep inline-flex items-center gap-1">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-brand text-white p-10 sm:p-14 shadow-soft">
          ...
          <div className="relative grid md:grid-cols-2 gap-6 items-center">
            <div>
              <h2 className="font-display text-3xl sm:text-4xl">Need care today? We're one call away.</h2>
              <p className="mt-3 text-white/90 max-w-lg">Speak to our coordinator and get a nurse, caregiver or doctor scheduled within hours.</p>
            </div>
